Button realnum3= (Button)findViewById(R.id.real_number_system);
        ...
        Button simple_interest1= (Button)findViewById(R.id.simple_interest);

        simple_interest1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        Button algebra1= (Button)findViewById(R.id.algebra);

        algebra1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
        ...
        Button transformation1= (Button)findViewById(R.id.transformation);
        ...
        drawing1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent int29=new Intent(cmathone.this,cmathchapter_fifteen.class);
                startActivity(int29);
        ...
        statistics1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent int30=new Intent(cmathone.this,cmathchapter_sixteen.class);
                startActivity(int30);
            }
        });
